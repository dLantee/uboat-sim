...
class SubItem(QtWidgets.QGraphicsItem):
    """
    Simple submarine marker. Position in scene == world meters (1:1 scale).
    ...
    def __init__(self, eid: str, parent=None) -> None:
        ...
        self._pen = QtGui.QPen(QtGui.QColor(0, 180, 120), 1.0)
        self._brush = QtGui.QBrush(QtGui.QColor(0, 80, 60, 180))
